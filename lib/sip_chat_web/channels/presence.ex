defmodule SipChatWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SipChat.MyChannel do
        use SipChatWeb, :channel
        alias SipChatWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :sip_chat,
                        pubsub_server: SipChat.PubSub
end
